        ...
        <div class="row">
            ...
            <div class="col-lg-6">
            	<div class="toggle_info">
                	<span><i class="fas fa-user"></i>Returning customer? <a href="{{ route('login.index')}}" data-bs-toggle="collapse" class="collapsed" aria-expanded="false">Click here to login</a></span>
                </div>
            </div>
            <div class="col-lg-6">
            	<div class="toggle_info">
                ...
                <div class="panel-collapse collapse coupon_form" id="coupon">
                    <div class="panel-body">
                        ...
                        <div class="coupon field_form input-group">
                            <input type="text" value=""  id="coupon-code" name="coupon_code" class="form-control" placeholder="Enter Coupon Code..">
