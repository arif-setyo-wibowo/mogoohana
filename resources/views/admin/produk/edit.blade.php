...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">MogoOhana/</span> Update Product</h4>
                ...
                <form action="{{ route('produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-floating form-floating-outline mb-4">
                        <input type="text" class="form-control" id="nama_produk" name="nama_produk"
                               value="{{ old('nama_produk', $produk->nama_produk) }}" placeholder="Product Name" required/>
                    ...
                    <div class="form-floating form-floating-outline mb-4">
                        <input type="text" class="form-control" id="harga" name="harga"
                               ...
                               placeholder="Selling Price" pattern="^\d+(\.\d{1,2})?$" required/>
                    ...
                    <div class="form-floating form-floating-outline mb-4">
                        <input type="text" class="form-control" id="harga_diskon" name="harga_diskon"
                               ...
                               placeholder="Original Price" pattern="^\d+(\.\d{1,2})?$"/>
